...
function nposl() {
  return (
    <>
      <Head>
        <title>
          Non-Profit Open Software License 3.0 (NPOSL-3.0) -- BANIDB.com
        </title>
      </Head>
      <div className="container pt-5 px-5">
        <div className="row pt-5 px-5">
          <h1>Non-Profit Open Software License 3.0 (NPOSL-3.0)</h1>
          <div className="">
          <div className="text-right px-5 py-4">
              <p>
                This Non-Profit Open Software License (“Non-Profit OSL”) version
                3.0 (the “License”) applies to any original work of authorship
                (the “Original Work”) whose owner (the “Licensor”) has placed
                the following licensing notice adjacent to the copyright notice
              ...
              <p>
                ...
                communicate shall be licensed under this Non-Profit Open
              ...
              <p>
                3) Grant of Source Code License. The term “Source Code” means
                ...
                the Original Work. Licensor agrees to provide a machine-readable
                copy of the Source Code of the Original Work along with each
                copy of the Original Work that Licensor distributes. Licensor
                reserves the right to satisfy this obligation by placing a
                machine-readable copy of the Source Code in an information
                repository reasonably calculated to
                <br />
              ...
              <p>
                ...
                intellectual property. No patent license is granted to make,
                use, sell, offer
                <br />
                for sale, have made, or import embodiments of any patent claims
                other than the licensed claims defined in Section 2. No license
                is granted to the trademarks of Licensor even if such marks are
              ...
              <p>
                ...
                must treat any External Deployment by You of the Original Work
              ...
              <p>
                ...
                carry a prominent
                <br />
                Attribution Notice reasonably calculated to inform recipients
              ...
              <p>
                ...
                of liability shall not apply to the extent applicable law
              ...
              <p>
                ...
                recipients to
                <br />
                the terms of this License. This License conditions your rights
                to undertake the activities listed in Section 1, including your
                right to create Derivative Works based upon the Original Work,
                and doing so without honoring these terms and conditions is
                prohibited by copyright law and international treaty.
              </p>

              <p>
                Nothing in this License is intended to affect copyright
              ...
              <p>
                ...
                action, including a cross-claim or counterclaim, against
                Licensor or any licensee alleging that the Original Work
                infringes a patent. This termination provision shall not apply
                for an action alleging patent infringement by combinations of
                the Original Work with other
                <br />
              ...
              <p>
                ...
                relating to this License may be br /ought only in the courts of
                a jurisdiction wherein the Licensor resides or in which Licensor
                ...
                of copyright or patent law in the appropriate jurisdiction. This
              ...
              <p>
                13) Miscellaneous. If any provision of this License is held to
                be
                <br />
              ...
              <p>
                ...
                or communicate this License without modification. Nothing in
                this License permits You to modify this License as applied to
                the Original Work or to Derivative Works. However, You may
                modify the text of this License and copy, distribute or
                communicate your
                <br />
                modified version (the “Modified License”) and apply it to other
                original works of authorship subject to the following
                conditions: (i) You may not indicate in any way that your
                Modified License is the “Open Software License” or “OSL” and you
                may not use those names in the name of your Modified License;
                (ii) You must replace the notice specified in the first
                paragraph above with the notice
                <br />
                “Licensed under ” or with a notice of your own that is not
                confusingly similar to the notice in this License; and (iii) You
                may not claim that your original works are open source software
                unless your Modified License has been approved by Open Source
              ...
              <p>
                {" "}
                17) Non-Profit Amendment. The name of this amended version of
                the Open Software License (“OSL 3.0”) is “Non-Profit Open
                Software License 3.0”. The original OSL 3.0 license has been
                amended as follows:
              </p>
              ...
              <p>
                ...
                distribution of the Original Work or Derivative Works thereof,
                or from support or services relating thereto.
              </p>

              <p>
                (b) The first sentence of Section 7 [“Warranty of Provenance”]
                of OSL 3.0 has been stricken. For Original Works licensed under
                this Non-Profit OSL 3.0, LICENSOR OFFERS NO WARRANTIES
                WHATSOEVER.
              </p>
              ...
              <p>
                ...
                this
                <br />
                “Non-Profit Open Software License” rather than the “Open
                Software License”.
              </p>

              <p>
                You may distribute or communicate the Original Work or
                Derivative Works thereof under this Non-Profit OSL 3.0 license
                only if You make the representation and declaration in paragraph
                (a) of this Section 17.
              </p>

              <p>
                Otherwise, You shall distribute or communicate the Original Work
                or Derivative Works thereof only under the OSL 3.0 license and
                You shall publish clear licensing notices so stating. Also by
                way of clarification, this License does not authorize You to
                distribute or communicate works under this Non-Profit OSL 3.0 if
